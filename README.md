...
<p align="center">
  <img src="assets/biodefense-case-scan.gif?v=6c2093151936" alt="Current BioDefense intelligence case interface" width="100%">
</p>
...
|----------------|---------------------|------------------|
| **Case:** `BID-2026-6172`<br>**Campaign:** `BDC-2026-001` | **Record:** `OPEN`<br>**Evidence:** `MANIFEST-TRACKED` | `XML` · `JSON` · `CSV` · `XLSX` |
...
|----------|--------------------|-------|
| **ID:** BDC-2026-001<br>**Campaign:** Coordinated Biomedical Systems Intrusion<br>**Designation:** BMSI-01 | **Phase:** Operational Recovery<br>**Containment:** HIGH<br>**Intrusions:** 13 | **Active Cases:** 113<br>**Evidence:** 95,288<br>**Indicators:** 62,990<br>**Facilities / States:** 11 / 3 |
...
|--------------|--------------------|----------|
| **Case:** BID-2026-6172<br>**Classification:** Research Data Integrity Investigation<br>**Threat Family:** Research Workstation Compromise<br>**Severity / Priority:** LOW / ROUTINE | **Platform:** Medical Research Laboratory<br>**Vendor / Device:** HPE / Laboratory Information Server<br>**Zone:** Evidence Network<br>**Assets:** 5 | **Confidence:** 88%<br>**Evidence / IOCs:** 51 / 15<br>**Lead:** Analyst Team Bravo<br>**Initial Access:** Web Application Exploitation |
...
**Threat Family:** Research Workstation Compromise · **Repository Updated:** 2026-08-12T04:04:14Z
...
| Metric | Value |
|--------|------:|
| Total Investigations | 113 |
| Low / Moderate | 29 / 37 |
| High / Critical | 34 / 13 |
| Closed Cases | 0 |
| Average Confidence | 89.6% |
| Total Evidence | 95,288 |
| Total Indicators | 62,990 |
