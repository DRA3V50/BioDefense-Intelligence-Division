...
<p align="center">
  <img src="assets/biodefense-case-scan.gif?v=c5409279e689" alt="Current BioDefense intelligence case interface" width="100%">
</p>
...
|----------------|---------------------|------------------|
| **Case:** `BID-2026-3128`<br>**Campaign:** `BDC-2026-001` | **Record:** `FIELD COORDINATION`<br>**Evidence:** `MANIFEST-TRACKED` | `XML` · `JSON` · `CSV` · `XLSX` |
...
|----------|--------------------|-------|
| **ID:** BDC-2026-001<br>**Campaign:** Coordinated Biomedical Systems Intrusion<br>**Designation:** BMSI-01 | **Phase:** Operational Recovery<br>**Containment:** HIGH<br>**Intrusions:** 17 | **Active Cases:** 133<br>**Evidence:** 98,176<br>**Indicators:** 63,989<br>**Facilities / States:** 11 / 3 |
...
|--------------|--------------------|----------|
| **Case:** BID-2026-3128<br>**Classification:** Medical Device Security Assessment<br>**Threat Family:** Clinical Research Data Manipulation<br>**Severity / Priority:** MODERATE / ELEVATED | **Platform:** Laboratory Control Network<br>**Vendor / Device:** Dell / Medical Device Gateway<br>**Zone:** Research Operations<br>**Assets:** 12 | **Confidence:** 95%<br>**Evidence / IOCs:** 38 / 31<br>**Lead:** Joint Cyber Investigation Unit<br>**Initial Access:** Third-Party Access |
...
|---------------|--------:|
| Biosecurity Audit Record | 7 |
| Analyst Observation | 5 |
| Firewall Log | 4 |
| Access Control Log | 4 |
...
| 2026-08-21 | BID-2026-5945 | MODERATE | 42 | 88 | Evidence Collection |
| 2026-08-20 | BID-2026-2218 | HIGH | 80 | 90 | Containment |
| 2026-08-20 | BID-2026-7168 | CRITICAL | 85 | 91 | Open |

</details>

**Threat Family:** Clinical Research Data Manipulation · **Repository Updated:** 2026-08-22T02:50:38Z
...
| Metric | Value |
|--------|------:|
| Total Investigations | 133 |
| Low / Moderate | 30 / 47 |
| High / Critical | 39 / 17 |
| Closed Cases | 0 |
| Average Confidence | 89.5% |
| Total Evidence | 98,176 |
| Total Indicators | 63,989 |
...
| BID-2026-5945 | Laboratory Security Breach Investigation | MODERATE |
| BID-2026-2218 | Supply Chain Security Investigation | HIGH |
| BID-2026-7168 | Medical Device Security Assessment | CRITICAL |
