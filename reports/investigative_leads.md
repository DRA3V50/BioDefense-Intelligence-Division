...
**Evidence Records Reviewed:** 38

**Correlation Records Reviewed:** 38
...
- `BID-2026-3128-EV-0020` — Authentication Log; source: Unknown Device; integrity: Verified
- `BID-2026-3128-EV-0021` — Authentication Log; source: Unknown Device; integrity: Verified
- `BID-2026-3128-EV-0036` — Authentication Log; source: Unknown Device; integrity: Verified
...
- `BID-2026-3128-EV-0012` — Access Control Log; source: Unknown Device; integrity: Verified
- `BID-2026-3128-EV-0019` — Access Control Log; source: Unknown Device; integrity: Verified
- `BID-2026-3128-EV-0025` — Access Control Log; source: Unknown Device; integrity: Verified
- `BID-2026-3128-EV-0027` — Access Control Log; source: Unknown Device; integrity: Verified
...
- `BID-2026-3128-EV-0010` — Laboratory Information System Audit Log; source: Unknown Device; integrity: Verified
- `BID-2026-3128-EV-0029` — Laboratory Information System Audit Log; source: Unknown Device; integrity: Verified
- `BID-2026-3128-EV-0028` — Laboratory System Configuration; source: Unknown Device; integrity: Verified
...
- `BID-2026-3128-EV-0008` — Research Data Integrity Record; source: Unknown Device; integrity: Verified
- `BID-2026-3128-EV-0014` — Research Data Integrity Record; source: Unknown Device; integrity: Verified
- `BID-2026-3128-EV-0024` — Research Data Integrity Record; source: Unknown Device; integrity: Verified
...
- `BID-2026-3128-EV-0003` — Network Connection Record; source: Unknown Device; integrity: Verified
- `BID-2026-3128-EV-0022` — Network Connection Record; source: Unknown Device; integrity: Verified
- `BID-2026-3128-EV-0033` — Network Connection Record; source: Unknown Device; integrity: Verified
- `BID-2026-3128-EV-0005` — Firewall Log; source: Unknown Device; integrity: Verified
- `BID-2026-3128-EV-0011` — Firewall Log; source: Unknown Device; integrity: Verified
- `BID-2026-3128-EV-0032` — Firewall Log; source: Unknown Device; integrity: Verified
- `BID-2026-3128-EV-0038` — Firewall Log; source: Unknown Device; integrity: Verified
...
- `BID-2026-3128-EV-0009` — Threat Intelligence Record; source: Unknown Device; integrity: Verified
- `BID-2026-3128-EV-0016` — Threat Intelligence Record; source: Unknown Device; integrity: Verified
...
- `BID-2026-3128-EV-0001` — Biosecurity Audit Record; source: Unknown Device; integrity: Verified
- `BID-2026-3128-EV-0004` — Biosecurity Audit Record; source: Unknown Device; integrity: Verified
- `BID-2026-3128-EV-0006` — Biosecurity Audit Record; source: Unknown Device; integrity: Verified
- `BID-2026-3128-EV-0007` — Biosecurity Audit Record; source: Unknown Device; integrity: Verified
- `BID-2026-3128-EV-0013` — Biosecurity Audit Record; source: Unknown Device; integrity: Verified
- `BID-2026-3128-EV-0017` — Biosecurity Audit Record; source: Unknown Device; integrity: Verified
- `BID-2026-3128-EV-0018` — Biosecurity Audit Record; source: Unknown Device; integrity: Verified
- `BID-2026-3128-EV-0035` — Containment Validation Record; source: Unknown Device; integrity: Verified
...
|------------|-----------------:|------------|
| Biomedical Research Espionage | 56 | MODERATE |
| Laboratory-System Sabotage | 54 | MODERATE |
| Preparation for a Cyber-Enabled Biological Attack | 49 | MODERATE |
...
|--------------|----------------|----------|------------|
| BID-2026-2218 | Supply Chain Security Investigation | HIGH | matching threat family |
...
- 38 evidence records remain pending analyst review.
...
- [Evidence Manifest](../evidence/BID-2026-3128/evidence_manifest.json)
- [Evidence Correlations](../evidence/BID-2026-3128/evidence_correlations.json)
- [Chain of Custody](../evidence/BID-2026-3128/chain_of_custody.md)
- [Forensic Summary](../evidence/BID-2026-3128/forensic_summary.md)
