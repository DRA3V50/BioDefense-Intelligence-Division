...
The active Research Data Integrity Investigation concerns suspected Unauthorized Laboratory Network Access. The calculated overall bioterror threat score is **34/100 (GUARDED)**. The strongest risk drivers are containment confidence, attribution confidence, threat actor intent. This assessment supports defensive prioritization and investigative planning; it does not establish that a biological agent was released or that a physical bioterror event occurred.

**Overall Bioterror Threat Level:** GUARDED

**Overall Bioterror Threat Score:** 34/100
...
|----------------------|------:|-------|
| Threat Actor Intent | 54/100 | ELEVATED |
| Threat Actor Capability | 41/100 | GUARDED |
| Biological Target Value | 37/100 | GUARDED |
| Laboratory and Specimen Impact | 24/100 | GUARDED |
| Public-Health Risk | 22/100 | GUARDED |
| Cyber-to-Physical Escalation | 29/100 | GUARDED |
| Attribution Confidence | 80/100 | MODERATE |
...
**Integrity-Verified Records:** 25

**Pending Analyst Review:** 25
...
**Intent Assessment:** 54/100 (ELEVATED)

**Capability Assessment:** 41/100 (GUARDED)
