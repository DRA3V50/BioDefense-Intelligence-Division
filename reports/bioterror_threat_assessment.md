...
The active Unauthorized Research System Access concerns suspected Medical Device Communications Interference. The calculated overall bioterror threat score is **71/100 (HIGH)**. The strongest risk drivers are containment confidence, threat actor intent, threat actor capability. This assessment supports defensive prioritization and investigative planning; it does not establish that a biological agent was released or that a physical bioterror event occurred.

**Overall Bioterror Threat Level:** HIGH

**Overall Bioterror Threat Score:** 71/100
...
|----------------------|------:|-------|
| Threat Actor Intent | 89/100 | CRITICAL |
| Threat Actor Capability | 89/100 | CRITICAL |
| Biological Target Value | 87/100 | CRITICAL |
| Laboratory and Specimen Impact | 77/100 | HIGH |
| Public-Health Risk | 55/100 | ELEVATED |
| Cyber-to-Physical Escalation | 68/100 | ELEVATED |
| Attribution Confidence | 82/100 | MODERATE |
...
**Integrity-Verified Records:** 54

**Pending Analyst Review:** 54
...
**Intent Assessment:** 89/100 (CRITICAL)

**Capability Assessment:** 89/100 (CRITICAL)
